...
public class GuraHumorului extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "GuraHumoruluiPrefs";
    private static final String USER_IMAGES_KEY = "userImages_GuraHumorului";
    ...
    private static final String GURA_HUMORULUI_CITY_ID = "680963";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + GURA_HUMORULUI_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapButton.setText("Harta Interactivă Gura Humorului");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Gura Humorului location
            Uri gmmIntentUri = Uri.parse("geo:47.5533,25.8902?q=Gura+Humorului,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("bucovina_humor_1");
        defaultImages.add("bucovina_humor_manastire");
        defaultImages.add("bucovina_humor_voronet");
        defaultImages.add("bucovina_humor_parc");
        defaultImages.add("bucovina_humor_panorama");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul de Film și Diaporamă - 15-17 Iulie 2024",
                "Expo Artă Bucovineană - 22-24 Iulie 2024",
                "Târgul Meșterilor Populari - 5-7 August 2024",
                "Ziua Orașului Gura Humorului - 15 August 2024"
        };

        String[] tips = {
                "Vizitați Mănăstirea Voroneț dimineața pentru cea mai bună lumină pentru fotografii",
                "Parcul Ariniș oferă activități pentru toate vârstele și budget-uri",
                "Rezervația de urși este deschisă doar la anumite ore - verificați programul în avans",
                "Încercați plăcintele poale-n brâu la Pensiunea Bucovina din centrul orașului"
        };
        ...
        weatherTitle.setText("Vremea în Gura Humorului");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Gura Humorului");
        ...
        tipsTitle.setText("Sfaturi pentru Gura Humorului");
        ...
        photoTitle.setText("Provocare Foto: Capturați Gura Humorului");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Gura Humorului și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Gura Humorului! Aceasta este vizita ta #" + visitCount);
    ...
    protected void initializeSpecificContent() {
        ...
        setTitle("Gura Humorului");

        // Add sections
        addSection(
                findViewById(R.id.cityContentContainer),
                "Istorie și Tradiție",
                "Gura Humorului este un orășel cu o istorie bogată, dezvoltat în perioada administrației austriece a Bucovinei. Numele său provine de la râul Humor care își varsă apele în Moldova. Orașul a cunoscut o dezvoltare semnificativă la sfârșitul secolului al XIX-lea, când a devenit un important nod feroviar și centru de prelucrare a lemnului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Orașul este situat într-o depresiune pitorească din județul Suceava, la confluența râurilor Humor și Moldova, fiind înconjurat de dealuri împădurite și munți. Această poziție privilegiată în inima Bucovinei îi conferă un farmec aparte și un aer montan revigorant, cu climă temperată și o biodiversitate bogată.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Gura Humorului este un important punct de plecare pentru vizitarea mănăstirilor pictate, în special Voroneț și Humor. În oraș se găsesc Muzeul Obiceiurilor Populare din Bucovina și Parcul Ariniș, cu multiple facilități pentru agrement. În apropierea orașului se află și Rezervația de urși sau Observatorul Astronomic.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Orașul păstrează tradiții bucovinene autentice, organizând periodic evenimente culturale și festivaluri folclorice. Casa de Cultură găzduiește expoziții și spectacole, iar Festivalul Internațional de Film, Diaporamă și Fotografie atrage anual participanți din întreaga lume, contribuind la promovarea valorilor culturale locale.",
                false
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Gastronomie",
                "Bucătăria locală oferă preparate tradiționale bucovinene, precum borșul rădăuțean, tochitura bucovineană, sarmalele, plăcintele poale-n brâu și păstrăvul afumat. Restaurantele și pensiunile din oraș propun meniuri care valorifică ingrediente locale de calitate, oferind vizitatorilor o experiență gastronomică autentică.",
                false
        );
        ...
        // Add Voronet Monastery attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Mănăstirea Voroneț",
                R.drawable.manastire_voronet, // Make sure this resource exists
                "Părerea ta despre Mănăstirea Voroneț"
        );

        // Add Humor Monastery attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Mănăstirea Humor",
                R.drawable.manastire_humor, // Make sure this resource exists
                "Părerea ta despre Mănăstirea Humor"
        );
    }
