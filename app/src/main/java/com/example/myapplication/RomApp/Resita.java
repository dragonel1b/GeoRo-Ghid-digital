...
public class Resita extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "ResitaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Resita";
    ...
    private static final String RESITA_CITY_ID = "668399";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + RESITA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Reșița
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            ...
            android.util.Log.e("Resita", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Reșița");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Resita location
            Uri gmmIntentUri = Uri.parse("geo:45.2971,21.8906?q=Resita,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("resita_1");
        defaultImages.add("resita_furnale");
        defaultImages.add("resita_parc");
        defaultImages.add("resita_muzeul_locomotivelor");
        defaultImages.add("resita_centru");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Zilele Reșiței - 1-3 Iulie 2024",
                "Expoziție de locomotive istorice - 15 Iulie 2024",
                "Festival Industrial - 5-7 August 2024",
                "Târgul meșteșugarilor - 20-22 August 2024"
        };

        String[] tips = {
                "Vizitați Muzeul de Locomotive cu Abur la orele dimineții pentru mai puțini vizitatori",
                "Cea mai bună mâncare bănățeană se găsește la 'Restaurant Semenic'",
                "O plimbare în parcul Cărășana dimineața devreme este reconfortantă",
                "Furnalele Istorice pot fi vizitate gratuit în prima duminică a lunii"
        };
        ...
        weatherTitle.setText("Vremea în Reșița");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Reșița");
        ...
        photoTitle.setText("Provocare Foto: Capturați Reșița");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Reșița și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Reșița! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Reșița
    ...
    protected void initializeSpecificContent() {
        ...
        // Add Locomotive Museum attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Locomotivelor cu Abur",
                R.drawable.resita_muzeul_locomotivelor, // Folosim o resursă existentă
                "Părerea ta despre Muzeul Locomotivelor"
        );

        // Add Furnale Istorice attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Furnalele Istorice",
                R.drawable.resita_furnale, // Folosim o resursă existentă
                "Părerea ta despre Furnalele Istorice"
        );
    }
