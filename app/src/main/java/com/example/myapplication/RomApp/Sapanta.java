...
public class Sapanta extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "SapantaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Sapanta";
    ...
    private static final String SAPANTA_CITY_ID = "667854"; // Sapanta city ID
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + SAPANTA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Săpânța
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Săpânța");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Sapanta location
            Uri gmmIntentUri = Uri.parse("geo:47.9803,23.6962?q=Sapanta,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("maramures_sapanta_1");
        defaultImages.add("maramures_sapanta_cimitir");
        defaultImages.add("maramures_sapanta_cruce");
        defaultImages.add("maramures_sapanta_biserica");
        defaultImages.add("maramures_sapanta_traditional");
    ...
    private void addWeatherWidget() {
        ...
        weatherTitle.setText("Vremea în Săpânța");
    ...
    private String getRandomWeatherCondition() {
        String[] conditions = {
                "Însorit", "Parțial noros", "Noros", "Ploaie ușoară", "Averse", "Vreme bună"
        };
    ...
    private void addTouristRoutes() {
        ...
        routesInfo.setText("1. Cimitirul Vesel - Biserica de lemn\n" +
                "2. Casa-Muzeu Stan Ioan Pătraș\n" +
                "3. Săpânța - Peri (cea mai înaltă biserică de lemn din lume)\n" +
                "4. Traseu cultural prin sat și împrejurimi");
    ...
    private void addPhotoChallenge() {
        ...
        photoTitle.setText("Provocare Foto: Capturați Săpânța");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Săpânța și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Săpânța! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Săpânța
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Cimitirul Vesel",
                "Cimitirul Vesel din Săpânța este un cimitir unic în lume, cunoscut pentru crucile sale colorate din lemn de stejar și pentru epitafurile naive, pline de umor, care povestesc viața celui trecut în neființă. Creat de meșterul Stan Ioan Pătraș în 1935, cimitirul reprezintă o atitudine aparte față de moarte, văzută ca o trecere naturală, uneori chiar privită cu umor.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Pe lângă faimosul Cimitir Vesel, Săpânța oferă și alte atracții turistice valoroase: Biserica de lemn Săpânța-Peri (cea mai înaltă biserică de lemn din lume, având 78 metri), Casa-Muzeu Stan Ioan Pătraș, unde se pot admira lucrări ale meșterului, precum și ateliere tradiționale unde se poate observa procesul de realizare a crucilor și a altor obiecte tradiționale.",
                true
        );
        ...
        addSection(
                ...
                "Săpânța este un centru important al tradițiilor maramureșene, cu meșteșuguri bine păstrate precum sculptura în lemn, realizarea de porți tradiționale, țesutul covoarelor și al pânzei, precum și arta costumelor populare. Localnicii continuă să poarte cu mândrie portul tradițional la sărbători și evenimente importante.",
                false
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Gastronomie Locală",
                "Bucătăria din Săpânța păstrează rețetele tradiționale maramureșene: balmoș, tocană de miel, mămăligă cu brânză și smântână, carne afumată și preparate din porc, plăcinte tradiționale cu brânză și mărar. Horinca (țuica locală) și pălinca sunt băuturile tradiționale care însoțesc de obicei mesele.",
                false
        );
        ...
        // Add Cimitirul Vesel attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Cimitirul Vesel",
                R.drawable.cimitir_vesel, // Make sure this resource exists
                "Părerea ta despre Cimitirul Vesel"
        );

        // Add Biserica de lemn attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Biserica Săpânța-Peri",
                R.drawable.biserica_sapanta, // Make sure this resource exists
                "Părerea ta despre Biserica de lemn"
        );
    }
    ...
    protected String getCityDescription() {
        return "Săpânța, o comună din nordul Maramureșului, este renumită în întreaga lume pentru Cimitirul Vesel, un loc unic unde moartea este privită cu seninătate și umor, și pentru impresionanta Biserică de lemn Săpânța-Peri, cea mai înaltă din lume.";
    }
}
