...
public class Suceava extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "SuceavaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Suceava";
    ...
    private static final String SUCEAVA_CITY_ID = "680963";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + SUCEAVA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapButton.setText("Harta Interactivă Suceava");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Suceava location
            Uri gmmIntentUri = Uri.parse("geo:47.6635,26.2732?q=Suceava,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("bucovina_suceava_1");
        defaultImages.add("bucovina_suceava_cetate");
        defaultImages.add("bucovina_suceava_muzeu");
        defaultImages.add("bucovina_suceava_manastire");
        defaultImages.add("bucovina_suceava_panorama");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Medieval Ștefanian - 15-17 Iulie 2024",
                "Zilele Sucevei - 22-24 Iulie 2024",
                "Expoziție de Artă Tradițională - 5-20 August 2024",
                "Festivalul Național de Folclor - 10-12 August 2024"
        };

        String[] tips = {
                "Vizitați Cetatea de Scaun seara pentru iluminatul special",
                "Cea mai bună tochitura moldovenească se găsește la 'Casa Domnească'",
                "O plimbare prin Muzeul Satului Bucovinean dimineața devreme este o experiență de neuitat",
                "Muzeul Bucovinei este gratuit în prima duminică a lunii"
        };
        ...
        weatherTitle.setText("Vremea în Suceava");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Suceava");
        ...
        photoTitle.setText("Provocare Foto: Capturați Suceava");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Suceava și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Suceava! Aceasta este vizita ta #" + visitCount);
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Suceava, fostă capitală a Moldovei, este un oraș cu o bogată moștenire istorică, fiind reședința domnitorilor moldoveni între secolele XIV-XVI. Cetatea de Scaun a Sucevei, construită în timpul lui Petru I Mușat și extinsă de Ștefan cel Mare, reprezintă principalul vestigiu medieval al orașului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Suceava este situată în nord-estul României, pe râul Suceava, în regiunea istorică Bucovina. Orașul se întinde pe dealuri domoale, înconjurat de o zonă cu relief variat, de la câmpii până la dealuri împădurite și munți în depărtare. Clima este temperat-continentală, cu veri plăcute și ierni reci.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Cetatea de Scaun a Sucevei, Mănăstirea Sfântul Ioan cel Nou, Muzeul Satului Bucovinean și Hanul Domnesc sunt doar câteva dintre atracțiile care fac din Suceava un important centru turistic. Orașul servește și ca bază pentru explorarea mănăstirilor pictate din împrejurimi.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Un oraș cu o cultură bogată, influențată de tradiția moldovenească și bucovineană. Suceava găzduiește numeroase festivaluri și evenimente culturale, inclusiv Festivalul de Artă Medievală și Festivalul Ștefanian, care comemorează epoca lui Ștefan cel Mare.",
                false
        );
...
*/
        ...
        // Add Suceava Fortress attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Cetatea de Scaun",
                R.drawable.cetate_scaun, // Make sure this resource exists
                "Părerea ta despre Cetatea Sucevei"
        );

        // Add Stephen the Great Museum attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Bucovinei",
                R.drawable.muzeul_bucovinei, // Make sure this resource exists
                "Părerea ta despre Muzeul Bucovinei"
        );
    }
