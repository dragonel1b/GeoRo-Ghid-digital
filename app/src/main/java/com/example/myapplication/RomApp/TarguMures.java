...
public class TarguMures extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_targu_mures);

        sharedPreferences = getSharedPreferences("TarguMuresData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        cardViews = new ConstraintLayout[] {
                findViewById(R.id.cardCetatea),
                findViewById(R.id.cardBiblioteca),
                findViewById(R.id.cardPalat),
                findViewById(R.id.cardBiserica)
        };

        imageViews = new ImageView[] {
                findViewById(R.id.imageCetatea),
                findViewById(R.id.imageBiblioteca),
                findViewById(R.id.imagePalat),
                findViewById(R.id.imageBiserica)
        };

        checkViews = new ImageView[] {
                findViewById(R.id.checkCetatea),
                findViewById(R.id.checkBiblioteca),
                findViewById(R.id.checkPalat),
                findViewById(R.id.checkBiserica)
        };

        opinionViews = new TextInputEditText[] {
                findViewById(R.id.noteCetatea),
                findViewById(R.id.noteBiblioteca),
                findViewById(R.id.notePalat),
                findViewById(R.id.noteBiserica)
        };

        recommendationViews = new TextInputEditText[] {
                findViewById(R.id.recommendationCetatea),
                findViewById(R.id.recommendationBiblioteca),
                findViewById(R.id.recommendationPalat),
                findViewById(R.id.recommendationBiserica)
        };
    }
