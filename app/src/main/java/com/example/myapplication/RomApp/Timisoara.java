...
public class Timisoara extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "TimisoaraPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Timisoara";
    ...
    private static final String TIMISOARA_CITY_ID = "665087";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + TIMISOARA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Timișoara
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            ...
            android.util.Log.e("Timisoara", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Timișoara");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Timisoara location
            Uri gmmIntentUri = Uri.parse("geo:45.7489,21.2087?q=Timisoara,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("timisoara_1");
        defaultImages.add("timisoara_opera");
        defaultImages.add("timisoara_piata_unirii");
        defaultImages.add("timisoara_catedrala");
        defaultImages.add("timisoara_muzeul_revolutiei");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul JazzTM - 5-7 Iulie 2024",
                "Festivalul Plai - 13-15 Septembrie 2024",
                "Timișoara Capitală Culturală - Evenimente permanente",
                "Zilele Orașului Timișoara - 1-3 August 2024"
        };

        String[] tips = {
                "Vizitați Piața Unirii la apus pentru cea mai frumoasă priveliște",
                "Cea mai bună plăcintă bănățeană se găsește la 'Cofetăria Clasic'",
                "O plimbare pe malul Begăi dimineața devreme este o experiență de neuitat",
                "Muzeul Revoluției este gratuit în prima duminică a lunii"
        };
        ...
        weatherTitle.setText("Vremea în Timișoara");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Timișoara");
        ...
        photoTitle.setText("Provocare Foto: Capturați Timișoara");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Timișoara și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Timișoara! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Timișoara
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Timișoara este un oraș cu o istorie bogată, fiind primul oraș european iluminat electric (1884). A fost locul unde a început Revoluția Română din 1989, iar în 2023 a fost desemnată Capitală Culturală Europeană.",
                true
        );
        ...
        // Add National Theatre attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Teatrul Național",
                R.drawable.timisoara_teatru, // Folosim o resursă existentă
                "Părerea ta despre Teatrul Național"
        );

        // Add Metropolitan Cathedral attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Catedrala Metropolitană",
                R.drawable.timisoara_catedrala, // Folosim o resursă existentă
                "Părerea ta despre Catedrala Metropolitană"
        );
    }
