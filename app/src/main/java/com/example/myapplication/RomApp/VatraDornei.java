...
public class VatraDornei extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "VatraDorneiPrefs";
    private static final String USER_IMAGES_KEY = "userImages_VatraDornei";
    ...
    private static final String VATRADORNEI_CITY_ID = "662837";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + VATRADORNEI_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Vatra Dornei
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Vatra Dornei");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Vatra Dornei location
            Uri gmmIntentUri = Uri.parse("geo:47.3483,25.3594?q=Vatra+Dornei,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("bucovina_vatradornei_1");
        defaultImages.add("bucovina_vatradornei_parc");
        defaultImages.add("bucovina_vatradornei_schi");
        defaultImages.add("bucovina_vatradornei_izvoare");
        defaultImages.add("bucovina_vatradornei_panorama");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Usturoiului - 8-10 Iulie 2024",
                "Târgul de produse tradiționale - 15 Iulie 2024",
                "Festivalul Național de Folclor - 5-7 August 2024",
                "Zilele orașului Vatra Dornei - 15-17 August 2024"
        };

        String[] tips = {
                "Cel mai bun moment pentru tratament balnear este primăvara sau toamna",
                "Încercați apele minerale direct de la izvoare în Parcul Central",
                "Vizitați pârtiile de schi dimineața pentru a evita aglomerația",
                "Traseul către Vârful Ouşoru oferă cea mai bună panoramă asupra orașului"
        };
        ...
        weatherTitle.setText("Vremea în Vatra Dornei");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Vatra Dornei");
        ...
        photoTitle.setText("Provocare Foto: Capturați Vatra Dornei");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Vatra Dornei și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Vatra Dornei! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Vatra Dornei
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Vatra Dornei este un oraș cu o istorie bogată, menționat pentru prima dată în documente în anul 1592. Orașul a cunoscut o dezvoltare semnificativă în perioada habsburgică, când a devenit o stațiune balneoclimaterică renumită. Clădirea cazinoului, construită în 1898 în stil baroc vienez, este un simbol al acestei perioade de înflorire.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situată în Depresiunea Dornelor, la confluența râurilor Dorna și Bistrița, la o altitudine de aproximativ 802 m, Vatra Dornei se află într-un cadru natural spectaculos, înconjurată de munții Suhard, Giumalău, Călimani și Bistriței. Clima submontană, bogată în aerosoli și ioni negativi, conferă orașului proprietăți curative naturale.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Orașul este renumit pentru stațiunea balneară cu izvoarele sale de apă minerală, Parcul Central cu peste 50 de specii de arbori, pârtiile de schi (Dealul Negru, Parc și Veveriță), Muzeul Etnografic, Cazinoul din 1898 și băile minerale. Iubitorii de drumeții pot explora trasee montane către Vârful Ouşoru sau Rezervația 12 Apostoli.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Vatra Dornei găzduiește evenimente culturale importante precum Festivalul Usturoiului, Festivalul Național de Folclor și Zilele Orașului. Muzeul Etnografic prezintă obiecte tradiționale din zona Dornelor, inclusiv costume populare, unelte și ceramică. Biblioteca orășenească și Casa de Cultură sunt centre importante pentru activități culturale locale.",
                false
        );
...
*/
        ...
        // Add Cazinoul attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Cazinoul Băilor",
                R.drawable.cazinoul_bailor, // Make sure this resource exists
                "Părerea ta despre Cazinoul Băilor"
        );

        // Add Ski slopes attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Pârtiile de Schi",
                R.drawable.partii_schii, // Make sure this resource exists
                "Părerea ta despre pârtiile de schi"
        );
    }
