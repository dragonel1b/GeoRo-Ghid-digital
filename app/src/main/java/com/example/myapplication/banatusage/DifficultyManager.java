...
/**
 * Manager pentru sistemul de dificultate adaptiv al quiz-ului Banat
 */
public class DifficultyManager {
    private static final String TAG = "BanatDifficultyManager";
    private static final String PREFS_NAME = "BanatDifficulty";
    ...
    public String getPerformanceRecommendation() {
        ...
        if (totalGames == 0) {
            return "Bine ai venit în Banat! Începe cu nivelul Normal și vezi cum te descurci.";
        }
