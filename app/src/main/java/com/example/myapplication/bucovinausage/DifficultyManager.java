...
/**
 * Manager pentru sistemul de dificultate adaptiv al quiz-ului Bucovina
 */
public class DifficultyManager {
    private static final String TAG = "BucovinaDifficultyManager";
    private static final String PREFS_NAME = "BucovinaDifficulty";
    ...
    public String getPerformanceRecommendation() {
        ...
        if (totalGames == 0) {
            return "Bine ai venit în Bucovina! Începe cu nivelul Normal și vezi cum te descurci.";
        }
