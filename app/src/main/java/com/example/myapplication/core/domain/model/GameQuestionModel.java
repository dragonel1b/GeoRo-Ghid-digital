...
public class GameQuestionModel {
     ...
     */
    public GameQuestionModel(String question, String correctAnswer, List<String> incorrectAnswers, 
     ...
     */
    public GameQuestionModel(String question, String correctAnswer, int imageResourceId) {
     ...
     */
    public GameQuestionModel(String question, String correctAnswer) {
