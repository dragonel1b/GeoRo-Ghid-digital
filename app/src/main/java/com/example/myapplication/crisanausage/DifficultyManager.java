...
/**
 * Manager pentru sistemul de dificultate adaptiv al quiz-ului Crișana
 */
public class DifficultyManager {
    private static final String TAG = "CrisanaDifficultyManager";
    private static final String PREFS_NAME = "CrisanaDifficulty";
    ...
    public String getPerformanceRecommendation() {
        ...
        if (totalGames == 0) {
            return "Bine ai venit în Crișana! Începe cu nivelul Normal și vezi cum te descurci.";
        }
