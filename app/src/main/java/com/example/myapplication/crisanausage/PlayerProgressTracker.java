...
/**
 * Tracker pentru progresul jucătorului în quiz-ul Crișana
 */
public class PlayerProgressTracker {
    private static final String TAG = "CrisanaProgressTracker";
    private static final String PREFS_NAME = "CrisanaPlayerProgress";
