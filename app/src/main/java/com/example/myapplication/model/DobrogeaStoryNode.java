...
public class DobrogeaStoryNode {
    ...
    private DobrogeaStoryNode(Builder builder) {
    ...
    public static class Builder {
        ...
        private BetType betType = BetType.RED_BLACK;
        ...
        public Builder betType(BetType type) {
            this.betType = type;
            return this;
        }

        public Builder betRange(int min, int max) {
            this.minBet = min;
            this.maxBet = max;
            return this;
        }
        ...
        public DobrogeaStoryNode build() {
            validateNode();
            return new DobrogeaStoryNode(this);
        }
        ...
        private void validateNode() {
            ...
            if (nodeType == NodeType.BETTING && (minBet >= maxBet || minBet < 0)) {
                throw new IllegalStateException("Invalid bet range");
            }
        }
    }
    ...
    public boolean isBettingNode() { return nodeType == NodeType.BETTING; }
