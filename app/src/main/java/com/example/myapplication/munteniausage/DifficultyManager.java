...
/**
 * Manager pentru sistemul de dificultate adaptiv al quiz-ului Muntenia
 */
public class DifficultyManager {
    private static final String TAG = "MunteniaDifficultyManager";
    private static final String PREFS_NAME = "MunteniaDifficulty";
    ...
    public String getPerformanceRecommendation() {
        ...
        if (totalGames == 0) {
            return "Bine ai venit în Muntenia! Începe cu nivelul Normal și vezi cum te descurci.";
        }
