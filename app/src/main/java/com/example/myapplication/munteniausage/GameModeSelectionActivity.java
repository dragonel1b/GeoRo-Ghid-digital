...
/**
 * Activitate pentru selectarea modului de joc în quiz-ul Muntenia
 */
public class GameModeSelectionActivity extends AppCompatActivity {
    ...
    private void initializeComponents() {
        ...
        selectedGameMode = GameModeManager.GameMode.CLASSIC;
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Selectează Modul de Joc - Muntenia");
        }
    }
    
    private void setupRecyclerView() {
        gameModeAdapter = new GameModeAdapter(Arrays.asList(GameModeManager.GameMode.values()), 
            new GameModeAdapter.OnGameModeClickListener() {
                ...
                public void onGameModeClick(GameModeManager.GameMode gameMode) {
                    ...
                    if (gameMode == GameModeManager.GameMode.CATEGORY_FOCUS) {
    ...
    private void startSelectedGame() {
        if (selectedGameMode == GameModeManager.GameMode.CATEGORY_FOCUS && selectedCategory == null) {
        ...
        gameModeManager.initializeGameMode(selectedGameMode, selectedCategory);
