...
/**
 * Activitate modernizată pentru sfârșitul jocului în quiz-ul Muntenia
 */
public class GameOverActivity extends AppCompatActivity {
    ...
    private String getPerformanceMessage() {
        if (accuracy >= 0.95f) {
            return "🏆 Performanță perfectă! Ești un adevărat expert al Munteniei!";
        } else if (accuracy >= 0.85f) {
            return "🌟 Excelent! Cunoști foarte bine istoria și cultura Munteniei!";
        } else if (accuracy >= 0.75f) {
            return "👍 Foarte bine! Continuă să exersezi pentru a deveni expert!";
        } else if (accuracy >= 0.60f) {
            return "📚 Bine! Mai ai de învățat despre frumoasa regiune Muntenia!";
        } else {
    ...
    private void shareResults() {
        String shareText = "🎯 Am terminat un quiz despre Muntenia!\n\n" +
