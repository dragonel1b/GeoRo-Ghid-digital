...
/**
 * Tracker pentru progresul jucătorului în quiz-ul Muntenia
 */
public class PlayerProgressTracker {
    private static final String TAG = "MunteniaProgressTracker";
    private static final String PREFS_NAME = "MunteniaPlayerProgress";
