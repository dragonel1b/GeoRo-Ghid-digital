...
/**
 * Manager pentru sistemul de dificultate adaptiv al quiz-ului Transilvania
 */
public class DifficultyManager {
    private static final String TAG = "DifficultyManager";
    private static final String PREFS_NAME = "TransilvaniaDifficulty";
    ...
    public String getPerformanceRecommendation() {
        ...
        if (totalGames == 0) {
            return "Bine ai venit! Începe cu nivelul Normal și vezi cum te descurci.";
        }
