...
public class GameOverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (percentage == 100) {
            ...
            achievementsBuilder.append("• Expert al Transilvaniei (").append(correctAnswers)
                    .append(" din ").append(totalQuestions).append(" corecte)\n");
        } else if (percentage >= 60) {
            achievementsBuilder.append("• Cunoscător al Transilvaniei (").append(correctAnswers)
                    .append(" din ").append(totalQuestions).append(" corecte)\n");
        } else {
            achievementsBuilder.append("• Explorator al Transilvaniei (").append(correctAnswers)
                    .append(" din ").append(totalQuestions).append(" corecte)\n");
        }
    ...
    private void setupButtonListeners() {
        ...
        if (playAgainButton != null) {
            playAgainButton.setOnClickListener(v -> {
                Intent intent = new Intent(GameOverActivity.this, TransilvaniaGameActivity.class);
        ...
        if (shareButton != null) {
            shareButton.setOnClickListener(v -> {
                ...
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, "Scorul meu la Quizul despre Transilvania");
                shareIntent.putExtra(Intent.EXTRA_TEXT, 
                        "Am obținut " + scoreText + " puncte în Quizul despre Transilvania! " +
