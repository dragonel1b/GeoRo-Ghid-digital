...
public class Arad extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "AradPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Arad";
    ...
    private static final String ARAD_CITY_ID = "686254";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + ARAD_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Arad
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Arad");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Arad location
            Uri gmmIntentUri = Uri.parse("geo:46.1865,21.3122?q=Arad,Romania");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Arad");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Arad");
        ...
        photoTitle.setText("Provocare Foto: Capturați Arad");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Arad și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Arad! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Arad
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Aradul are o istorie bogată, fiind menționat documentar pentru prima dată în secolul al XI-lea. Orașul a fost un important centru al mișcării naționale românești și a jucat un rol semnificativ în Revoluția de la 1848. În decembrie 1918, Aradul a devenit sediul Consiliului Național Central Român.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situat în vestul României, în județul Arad, orașul este străbătut de râul Mureș și se află la poalele estice ale Câmpiei Panonice. Poziția sa geografică l-a transformat într-un important nod de transport și comunicații, fiind o poartă de intrare în România dinspre Europa Centrală.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Cetatea Aradului, o impresionantă fortăreață în stil Vauban, Palatul Cultural, un edificiu în stil eclectic, și Palatul Administrativ sunt doar câteva dintre monumentele remarcabile ale orașului. Malurile râului Mureș oferă spații verzi relaxante pentru locuitori și turiști.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Aradul este un important centru cultural, cu o bogată activitate teatrală, muzicală și artistică. Teatrul Clasic „Ioan Slavici, Filarmonica de Stat și numeroasele galerii de artă contribuie la viața culturală diversificată a orașului.",
                false
        );
...
*/
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Cetatea Aradului",
                R.drawable.cetate_arad, // Make sure this resource exists
                "Părerea ta despre Cazinou"
        );
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Biserica Roșie",
                R.drawable.biserica_rosie, // Make sure this resource exists
                "Părerea ta despre Farul Genovez"
        );
    }
    ...
    protected String getCityDescription() {
        return "Arad, important centru economic și cultural din vestul României, impresionează prin arhitectura sa diversă, de la clădiri baroce și secession până la monumente în stil eclectic.";
    }
}
