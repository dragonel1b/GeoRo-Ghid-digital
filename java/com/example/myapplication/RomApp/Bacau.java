...
public class Bacau extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "BacauPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Bacau";
    ...
    private static final String BACAU_CITY_ID = "685948";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + BACAU_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Bacău
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            viewCitiesButton.setOnClickListener(v -> {
                ...
                intent.putExtra(com.example.myapplication.viewmodel.CityListActivity.EXTRA_REGION_NAME, "Moldova");
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            });
        } else {
            android.util.Log.e("Bacau", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Bacău");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Bacau location
            Uri gmmIntentUri = Uri.parse("geo:46.5670,26.9138?q=Bacau,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("moldova_bacau_1");
        defaultImages.add("moldova_bacau_2");
        defaultImages.add("moldova_bacau_3");
        defaultImages.add("moldova_bacau_4");
        defaultImages.add("moldova_bacau_5");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Bacău");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Bacău");
        ...
        photoTitle.setText("Provocare Foto: Capturați Bacău");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Bacău și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Bacău! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Bacău
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Bacău este un oraș cu o istorie bogată, fiind atestat documentar din 6 octombrie 1408, într-un document emis de Alexandru cel Bun. De-a lungul secolelor, orașul s-a dezvoltat ca un important centru comercial la intersecția drumurilor care legau Transilvania de Moldova.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Orașul Bacău este situat în partea central-vestică a Moldovei, pe malul drept al râului Bistrița, la confluența acestuia cu Siretul. Așezat la contactul dintre Podișul Moldovei și Subcarpații Orientali, orașul se bucură de un cadru natural variat, cu dealuri line, lunci fertile și păduri în împrejurimi.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Printre obiectivele turistice importante se numără: Casa Memorială 'Vasile Alecsandri' din Mircești, Casa Memorială 'George Bacovia', Observatorul Astronomic 'Victor Anestin', Muzeul de Științe ale Naturii 'Ion Borcea', Muzeul de Artă Contemporană 'George Apostu' și Parcul Cancicov.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Bacăul este un important centru cultural al Moldovei, fiind orașul natal al poetului George Bacovia. Teatrul Municipal 'Bacovia', Filarmonica 'Mihail Jora' și numeroasele evenimente culturale organizate pe parcursul anului contribuie la viața culturală vibrantă a orașului.",
                false
        );
        ...
        AttractionHelper.addAttraction(
                ...
                R.drawable.casa_mem, // Make sure this resource exists
                "Părerea ta despre Casa memorială George Enescu"
        );
        ...
        AttractionHelper.addAttraction(
                ...
                R.drawable.lac_poiana, // Make sure this resource exists
                "Părerea ta despre Lacul de acumulare Poiana Uzului"
        );
    }
