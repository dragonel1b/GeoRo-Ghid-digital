...
public class BaiaMare extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "BaiaMarePrefs";
    private static final String USER_IMAGES_KEY = "userImages_BaiaMare";
    ...
    private static final String BAIA_MARE_CITY_ID = "685948"; // Baia Mare city ID
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + BAIA_MARE_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Baia Mare
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Baia Mare");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Baia Mare location
            Uri gmmIntentUri = Uri.parse("geo:47.6531,23.5698?q=Baia+Mare,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("maramures_baia_mare_1");
        defaultImages.add("maramures_baia_mare_centru");
        defaultImages.add("maramures_baia_mare_turnul_stefan");
        defaultImages.add("maramures_baia_mare_muzeul_satului");
        defaultImages.add("maramures_baia_mare_dealul_florilor");
    ...
    private void addWeatherWidget() {
        ...
        weatherTitle.setText("Vremea în Baia Mare");
    ...
    private String getRandomWeatherCondition() {
        String[] conditions = {
                "Însorit", "Parțial noros", "Noros", "Ploaie ușoară", "Averse", "Furtună"
        };
    ...
    private void addTouristRoutes() {
        ...
        routesInfo.setText("1. Centrul Vechi - Turnul Ștefan - Muzeul de Mineralogie\n" +
                "2. Muzeul Satului Maramureșean - Dealul Florilor\n" +
                "3. Bisericile de lemn din împrejurimi\n" +
                "4. Traseu montan spre Izvoare și Mogoșa");
    ...
    private void addPhotoChallenge() {
        ...
        photoTitle.setText("Provocare Foto: Capturați Baia Mare");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Baia Mare și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Baia Mare! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Baia Mare
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Baia Mare are o istorie bogată, fiind atestată documentar încă din secolul XIII-lea, sub numele de Rivulus Dominarum. Orașul s-a dezvoltat în jurul minelor de aur, argint și alte metale prețioase, ceea ce i-a adus și numele actual (Baia = mină în română).",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situat în nord-vestul României, în județul Maramureș, orașul este înconjurat de dealuri, fiind amplasat la poalele Munților Gutâi. Prin oraș curge râul Săsar, iar clima este moderat-continentală, influențată de relieful montan din apropiere.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Printre atracțiile notabile se numără Centrul Vechi cu Turnul Ștefan (turnul fostei biserici gotice), Muzeul de Mineralogie, Muzeul de Artă, Muzeul Județean de Istorie, Muzeul Satului Maramureșean, precum și Dealul Florilor, care oferă o panoramă spectaculoasă asupra orașului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Baia Mare este un important centru cultural al regiunii, cu o vibrantă scenă artistică, teatru, festivaluri și expoziții. Școala de pictură de la Baia Mare, înființată în 1896, a avut un impact semnificativ asupra artei românești moderne.",
                false
        );
        ...
        // Add Turnul Ștefan attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Turnul Ștefan",
                R.drawable.turn_stefan, // Make sure this resource exists
                "Părerea ta despre Turnul Ștefan"
        );

        // Add Muzeul Satului attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Satului Maramureșean",
                R.drawable.muzeu_sat, // Make sure this resource exists
                "Părerea ta despre Muzeul Satului"
        );
    }
    ...
    protected String getCityDescription() {
        return "Baia Mare, reședință a județului Maramureș, este un oraș cu o bogată istorie minieră, împrejmuit de dealuri și munți, cunoscut pentru colonia sa de artiști și pentru muzee unice precum cel de Mineralogie.";
    }
}
