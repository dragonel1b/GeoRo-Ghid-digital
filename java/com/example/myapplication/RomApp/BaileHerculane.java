...
public class BaileHerculane extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "BaileHerculanePrefs";
    private static final String USER_IMAGES_KEY = "userImages_BaileHerculane";
    ...
    private static final String BAILEHERCULANE_CITY_ID = "685767";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + BAILEHERCULANE_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Băile Herculane
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            viewCitiesButton.setOnClickListener(v -> {
                ...
                intent.putExtra(com.example.myapplication.viewmodel.CityListActivity.EXTRA_REGION_NAME, "Banat");
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            });
        } else {
            android.util.Log.e("BaileHerculane", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Băile Herculane");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Baile Herculane location
            Uri gmmIntentUri = Uri.parse("geo:44.8797,22.4119?q=Baile+Herculane,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("baile_herculane_1");
        defaultImages.add("baile_herculane_cazino");
        defaultImages.add("baile_herculane_catedrala");
        defaultImages.add("baile_herculane_statiune");
        defaultImages.add("baile_herculane_apele_termale");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Apelor Termale - 15-17 Iulie 2024",
                "Zilele Stațiunii Băile Herculane - 22-24 Iulie 2024",
                "Expoziție 'Istoria Băilor Imperiale' - 5-20 August 2024",
                "Festival Folcloric Valea Cernei - 10-12 August 2024"
        };

        String[] tips = {
                "Vizitați Băile Imperiale dimineața devreme pentru o experiență mai liniștită",
                "Cea mai bună plăcintă bănățeană se găsește la 'Cofetăria Imperială'",
                "Traseul spre Grota Haiducilor este cel mai accesibil dimineața",
                "Parcul Național Domogled-Valea Cernei oferă ghidaje gratuite în weekend"
        };
        ...
        weatherTitle.setText("Vremea în Băile Herculane");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Băile Herculane");
        ...
        photoTitle.setText("Provocare Foto: Capturați Băile Herculane");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Băile Herculane și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Băile Herculane! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Băile Herculane
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Băile Herculane este una dintre cele mai vechi stațiuni din Europa, cunoscută și frecventată încă din perioada romană (sec. I-II d.Hr). Conform legendei, însuși Hercule s-ar fi oprit aici pentru a se odihni și a se vindeca folosind proprietățile miraculoase ale apelor termale.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situată în sud-vestul României, în Valea Cernei, stațiunea este înconjurată de munții Domogled și Cernei. Microclimatul specific oferă ierni blânde și veri răcoroase, propice pentru tratamente balneare pe tot parcursul anului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Printre atracțiile principale se numără clădirile istorice în stil arhitectural austriac (Cazinoul, Băile Neptun, Băile Imperiale), Parcul Național Domogled-Valea Cernei, Grota Haiducilor și traseele montane din împrejurimi.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Băile Herculane are o moștenire culturală bogată, influențată de perioadele romană și austro-ungară. Vestigiile arheologice, monumentele și arhitectura distinctă reflectă importanța stațiunii de-a lungul istoriei.",
                false
        );
        ...
        // Add Băile Imperiale attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Băile Imperiale",
                R.drawable.campulung,//ic_bath, // Make sure this resource exists
                "Părerea ta despre Băile Imperiale"
        );

        // Add Grota Haiducilor attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Grota Haiducilor",
                R.drawable.grota_haiducilor, // Make sure this resource exists
                "Părerea ta despre Grota Haiducilor"
        );
    }
