...
public class Brasov extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "BrasovPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Brasov";
    ...
    private static final String BRASOV_CITY_ID = "683844";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + BRASOV_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Brasov
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Brașov");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Brasov location
            Uri gmmIntentUri = Uri.parse("geo:45.6426,25.5887?q=Brasov,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("transilvania_brasov_1");
        defaultImages.add("transilvania_brasov_cetate");
        defaultImages.add("transilvania_brasov_muntii");
        defaultImages.add("transilvania_brasov_piata");
        defaultImages.add("transilvania_brasov_biserica");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Cerbul de Aur - 15-20 August 2024",
                "Serbările Brașovului - 25-27 Aprilie 2024",
                "Festivalul Filmului Românesc - 10-15 Iunie 2024",
                "Maratonul Internațional Brașov - 2 Septembrie 2024"
        };

        String[] tips = {
                "Vizitați Biserica Neagră la răsărit pentru cele mai frumoase fotografii",
                "Urcați cu telecabina pe Tâmpa pentru o panoramă incredibilă asupra orașului",
                "Restaurantele de pe strada Republicii oferă cele mai autentice preparate transilvănene",
                "Vizitați Poiana Brașov chiar și vara pentru activități în aer liber"
        };
        ...
        weatherTitle.setText("Vremea în Brașov");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Brașov");
        ...
        photoTitle.setText("Provocare Foto: Capturați Brașov");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Brașov și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Brașov! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Brașov
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Brașov, cunoscut și ca Corona sau Kronstadt, este un important centru cultural și economic în inima României. Fondat de cavalerii teutoni în secolul al XIII-lea, orașul a fost un important centru comercial și meșteșugăresc al Transilvaniei medievale, păstrând și astăzi numeroase elemente de arhitectură gotică, renascentistă și barocă.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Brașov este amplasat în centrul României, în depresiunea Brașovului, la poalele Munților Carpați. Înconjurat de masivele Postăvaru, Piatra Mare și Tâmpa, orașul beneficiază de un cadru natural spectaculos. Cu o altitudine medie de 625 m, Brașov se bucură de un climat temperat-continental, cu ierni reci și veri plăcute.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Biserica Neagră, cel mai mare edificiu gotic din sud-estul Europei, Piața Sfatului cu impunătoarea Casă a Sfatului, străzile înguste din centrul vechi, Bastionul Țesătorilor și zidurile cetății sunt doar câteva dintre atracțiile care fac din Brașov un oraș unic. În apropiere se află celebrul castel Bran, cunoscut ca 'Castelul lui Dracula', stațiunea Poiana Brașov și complexul de fortificații Râșnov.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Brașov are o viață culturală bogată, cu instituții precum Opera Brașov, Filarmonica, Teatrul 'Sică Alexandrescu', Teatrul pentru Copii 'Arlechino' și numeroase muzee. Festivaluri de renume precum Festivalul Cerbul de Aur, Festivalul Internațional de Muzică de Cameră sau Festivalul Filmului Romanesc animă viața orașului pe tot parcursul anului.",
                false
        );
...
*/
        ...
        // Add Biserica Neagră attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Biserica Neagră",
                R.drawable.biserica_neagra, // Make sure this resource exists
                "Părerea ta despre Biserica Neagră"
        );

        // Add Tâmpa attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muntele Tâmpa",
                R.drawable.munte_tampa, // Make sure this resource exists
                "Părerea ta despre Tâmpa"
        );
    }
