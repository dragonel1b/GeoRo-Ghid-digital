...
public class Caransebes extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "CaransebesPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Caransebes";
    ...
    private static final String CARANSEBES_CITY_ID = "682729";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + CARANSEBES_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Caransebeș
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            ...
            android.util.Log.e("Caransebes", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Caransebeș");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Caransebes location
            Uri gmmIntentUri = Uri.parse("geo:45.4177,22.2192?q=Caransebes,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("caransebes_1");
        defaultImages.add("caransebes_panorama");
        defaultImages.add("caransebes_catedrala");
        defaultImages.add("caransebes_muzeul_etnografic");
        defaultImages.add("caransebes_centru");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Zilele Orașului Caransebeș - 1-3 Septembrie 2024",
                "Festival Folcloric 'Gugulan' - 15 August 2024",
                "Expoziție de Istorie Militară - 12-20 Iulie 2024",
                "Festivalul Fanfarelor - 10 Octombrie 2024"
        };

        String[] tips = {
                "Vizitați Muzeul de Etnografie dimineața pentru a evita aglomerația",
                "Cea mai bună mâncare tradițională bănățeană se găsește la restaurantul 'Banatul'",
                "O plimbare în Parcul Dragalina este recomandată în serile de vară",
                "Catedrala Ortodoxă poate fi vizitată zilnic între orele 8:00-19:00"
        };
        ...
        weatherTitle.setText("Vremea în Caransebeș");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Caransebeș");
        ...
        photoTitle.setText("Provocare Foto: Capturați Caransebeș");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Caransebeș și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Caransebeș! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Caransebeș
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Caransebeș are o istorie bogată ce datează din perioada romană. Poziția sa strategică la confluența râurilor Timiș și Sebeș a făcut-o un important centru comercial și militar de-a lungul secolelor.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Caransebeș este situat în sud-estul Banatului, la confluența râurilor Timiș și Sebeș, într-un cadru natural pitoresc, înconjurat de dealuri și munți. Clima este temperat-continentală cu influențe submediteraneene.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Printre atracțiile principale se numără Muzeul de Etnografie și al Regimentului de Graniță, Catedrala Ortodoxă 'Înălțarea Domnului', Episcopia Caransebeșului și centrul istoric al orașului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Caransebeș a fost un important centru cultural și spiritual pentru românii din Banat. Orașul are un teatru, muzee valoroase și găzduiește diverse evenimente culturale și festivaluri pe parcursul anului.",
                false
        );
        ...
        // Add Ethnographic Museum attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul de Etnografie și al Regimentului de Graniță",
                R.drawable.caransebes_muzeul_etnografic, // Folosim o resursă existentă
                "Părerea ta despre Muzeul de Etnografie"
        );

        // Add Caransebes Cathedral attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Catedrala Ortodoxă 'Înălțarea Domnului'",
                R.drawable.caransebes_catedrala, // Folosim o resursă existentă
                "Părerea ta despre Catedrala Ortodoxă"
        );
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Biserica Ortodoxă",
                R.drawable.caransebes_biserica, // Folosim o resursă existentă
                "Părerea ta despre Biserica Ortodoxă"
        );
    }
