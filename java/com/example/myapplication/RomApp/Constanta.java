...
public class Constanta extends EnhancedCityActivity {
    ...
    private static final String PREFS_NAME = "ConstantaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Constanta";
    ...
    private static final String CONSTANTA_CITY_ID = "680963";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + CONSTANTA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapButton.setText("Harta Interactivă Constanța");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Constanta location
            Uri gmmIntentUri = Uri.parse("geo:44.1598,28.6348?q=Constanta,Romania");
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Constanța, cunoscută în antichitate sub numele de Tomis, este cel mai vechi oraș atestat de pe teritoriul României. Fondată în secolul al VI-lea î.Hr. de coloniștii greci din Milet, a fost un important centru comercial și cultural în perioada romană, iar mai târziu a devenit parte a Imperiului Bizantin.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Constanța este situată în sud-estul României, pe coasta Mării Negre. Orașul se întinde pe o suprafață de aproximativ 124 km² și include numeroase lacuri precum Siutghiol și Tăbăcărie. Clima este temperat-continentală cu influențe maritime, cu veri călduroase și ierni blânde.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Cazinoul, Moscheea Carol I, Portul Tomis și plajele moderne sunt doar câteva dintre atracțiile care fac din Constanța o destinație turistică de top. Muzeul de Istorie Națională și Arheologie adăpostește comori de neprețuit, inclusiv statuia lui Glycon.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Un oraș multicultural unde se împletesc influențele române, grecești, turcești și tătare, creând un mozaic cultural unic. Constanța găzduiește numeroase festivaluri și evenimente culturale, inclusiv Festivalul Filmului European și Neversea.",
                false
        );
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Cazinoul",
                R.drawable.ic_casino, // Make sure this resource exists
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Farul Genovez",
                R.drawable.far_gen, // Make sure this resource exists
