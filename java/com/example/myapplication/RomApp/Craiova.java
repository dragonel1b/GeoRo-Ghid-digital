...
public class Craiova extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "CraiovaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Craiova";
    ...
    private static final String CRAIOVA_CITY_ID = "681290";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + CRAIOVA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Craiova
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Craiova");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Craiova location
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Craiova");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Craiova");
        ...
        photoTitle.setText("Provocare Foto: Descoperă Craiova");
        ...
        photoDesc.setText("Imortalizează cele mai frumoase locuri din Craiova și adaugă-le în colecția ta personală!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Craiova! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Craiova
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Craiova, unul dintre cele mai vechi orașe din România, își are originile în așezarea dacică Pelendava. A fost menționată documentar pentru prima dată în 1475, devenind reședință a boierilor Craioveşti în secolul al XV-lea. În secolul al XIX-lea a fost un important centru comercial și cultural al Olteniei.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Craiova este situată în sud-vestul României, pe malul stâng al râului Jiu, în centrul Olteniei. Orașul se află la aproximativ 227 km de București și are o suprafață de aproximativ 81,41 km². Clima este temperat-continentală cu influențe mediteraneene, cu veri calde și ierni relativ blânde.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Parcul Nicolae Romanescu (al treilea ca mărime din Europa), Centrul Vechi, Muzeul de Artă (cu opere ale lui Constantin Brâncuși), Casa Băniei și Grădina Botanică sunt principalele atracții ale Craiovei. Teatrul Național Marin Sorescu este, de asemenea, un important reper cultural și arhitectural.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Craiova este un important centru cultural, cu instituții precum Filarmonica Oltenia, Teatrul Național Marin Sorescu și Teatrul pentru Copii și Tineret Colibri. Orașul găzduiește anual Festivalul Internațional Shakespeare și festivalul de muzică IntenCity, și are o bogată tradiție literară, fiind orașul natal al lui Marin Sorescu și Ion D. Sîrbu.",
                false
        );
        ...
        AttractionHelper.addAttraction(
                ...
                R.drawable.parc_romanescu, // Make sure this resource exists
                "Părerea ta despre Parcul Romanescu"
        );
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Muzeul de Artă",
                R.drawable.muzeu_arta_craiova, // Make sure this resource exists
                "Părerea ta despre Muzeul de Artă"
        );

        // Add Teatrul Național attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Teatrul Național Marin Sorescu",
                R.drawable.teatru_marin, // Folosim ic_casino în loc de ic_theater
                "Părerea ta despre Teatrul Național"
        );

        // Add Casa Băniei attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Casa Băniei",
                R.drawable.casa_baniei, // Folosim ic_beach în loc de ic_landmark
                "Părerea ta despre Casa Băniei"
        );

        // Add Grădina Botanică attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Grădina Botanică",
                R.drawable.gradina_bot_craiova, // Folosim ic_park în loc de ic_garden
