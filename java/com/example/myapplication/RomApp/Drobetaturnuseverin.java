...
public class Drobetaturnuseverin extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "DrobetaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Drobeta";
    ...
    private static final String DROBETA_CITY_ID = "678817";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + DROBETA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Drobeta
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Drobeta");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Drobeta location
            Uri gmmIntentUri = Uri.parse("geo:44.6302,22.6500?q=Drobeta,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("oltenia_drobeta_1");
        defaultImages.add("oltenia_drobeta_parc");
        defaultImages.add("oltenia_drobeta_centru");
        defaultImages.add("oltenia_drobeta_podul_traian");
        defaultImages.add("oltenia_drobeta_cetate");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul de Blues de la Dunăre - August 2024",
                "Ziua Dunării - 29 Iunie 2024",
                "Zilele Cetății Severinului - Mai 2024",
                "Târgul Meșterilor Populari - Septembrie 2024"
        };

        String[] tips = {
                "Ruinele Podului lui Traian se văd cel mai bine de pe malul sârbesc (necesită trecere frontieră) sau de pe apă",
                "Muzeul Regiunii Porților de Fier găzduiește un acvariu cu pești din Dunăre",
                "O plimbare cu vaporașul prin Clisura Dunării oferă priveliști spectaculoase",
                "Castelul de Apă oferă o panoramă excelentă asupra orașului și Dunării"
        };
        ...
        weatherTitle.setText("Vremea în Drobeta-Turnu Severin");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Drobeta-Turnu Severin");
        ...
        photoTitle.setText("Provocare Foto: Descoperă Drobeta");
        ...
        photoDesc.setText("Imortalizează vestigiile istorice și peisajele Dunării de la Drobeta-Turnu Severin!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Drobeta-Turnu Severin! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Drobeta
    ...
    protected void initializeSpecificContent() {
        ...
        setTitle("Drobeta-Turnu Severin");

        // Add sections
        addSection(
                findViewById(R.id.cityContentContainer),
                "Istorie și Tradiție",
                "Drobeta-Turnu Severin, oraș cu o istorie milenară, își are originile în castrul roman Drobeta, construit de Împăratul Traian. Aici a fost ridicat celebrul Pod al lui Traian peste Dunăre. În Evul Mediu, a fost ridicată Cetatea Severinului, un punct strategic important. Orașul modern s-a dezvoltat începând cu secolul al XIX-lea.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situat pe malul stâng al Dunării, în apropierea Porților de Fier, Drobeta-Turnu Severin este reședința județului Mehedinți. Orașul se află într-o zonă de contact între Podișul Mehedinți și Lunca Dunării, beneficiind de un climat blând, submediteraneean.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Principalele atracții includ ruinele Castrului Roman Drobeta și ale Podului lui Traian, Cetatea Medievală a Severinului, Muzeul Regiunii Porților de Fier (cu secții de istorie, arheologie, etnografie și un acvariu), Castelul de Apă și faleza Dunării.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Drobeta-Turnu Severin găzduiește Palatul Cultural \"Theodor Costescu\", Teatrul \"I.D. Sârbu\" și numeroase evenimente culturale, inclusiv Zilele Cetății Severinului și Festivalul de Blues de la Dunăre. Muzeul Regiunii Porților de Fier este o instituție culturală de referință.",
                false
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Gastronomie",
                "Specific zonei este peștele de Dunăre, preparat în diverse moduri (saramură, plachie, prăjit). De asemenea, se pot degusta preparate tradiționale oltenești și influențe sârbești datorită proximității graniței. Vinurile din podgoriile locale completează experiența culinară.",
                false
        );
        ...
        // Add Podul lui Traian attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Podul lui Traian (Ruine)",
                R.drawable.podul_traian, // Utilizăm ic_beach temporar
                "Părerea ta despre Podul lui Traian"
        );

        // Add Cetatea Medievală attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Cetatea Medievală a Severinului",
                R.drawable.cetate_medievala_severin, // Utilizăm ic_casino temporar
                "Părerea ta despre Cetatea Medievală"
        );

        // Add Muzeul Regiunii Porților de Fier attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Regiunii Porților de Fier",
                R.drawable.muzeu_porti_fier,
                "Părerea ta despre Muzeul Porților de Fier"
        );

        // Add Castelul de Apă attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Castelul de Apă",
                R.drawable.catelul_de_apa, // Utilizăm ic_park temporar
                "Părerea ta despre Castelul de Apă"
        );

        // Add Faleza Dunării attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Faleza Dunării",
                R.drawable.faleza_dunare, // Utilizăm ic_beach temporar
                "Părerea ta despre Faleza Dunării"
        );
    }
