...
public class Iasi extends AppCompatActivity {
    ...
    private String[] locationKeys = {
            "palatul_culturii",
            "manastirea_trei_ierarhi",
            "catedrala_mitropolitana",
            "bojdeuca_ion_creanga",
            "parcul_copou",
            "palatul_roznovanu"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iasi); // Make sure to create this layout file

        sharedPreferences = getSharedPreferences("IasiData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        cardViews = new ConstraintLayout[] {
                findViewById(R.id.cardPalatulCulturii),
                findViewById(R.id.cardManastireaTreiIerarhi),
                findViewById(R.id.cardCatedralaMitropolitana),
                findViewById(R.id.cardBojdeucaIonCreanga),
                findViewById(R.id.cardParculCopou),
                findViewById(R.id.cardPalatulRoznovanu)
        };

        imageViews = new ImageView[] {
                findViewById(R.id.imagePalatulCulturii),
                findViewById(R.id.imageManastireaTreiIerarhi),
                findViewById(R.id.imageCatedralaMitropolitana),
                findViewById(R.id.imageBojdeucaIonCreanga),
                findViewById(R.id.imageParculCopou),
                findViewById(R.id.imagePalatulRoznovanu)
        };

        checkViews = new ImageView[] {
                findViewById(R.id.checkPalatulCulturii),
                findViewById(R.id.checkManastireaTreiIerarhi),
                findViewById(R.id.checkCatedralaMitropolitana),
                findViewById(R.id.checkBojdeucaIonCreanga),
                findViewById(R.id.checkParculCopou),
                findViewById(R.id.checkPalatulRoznovanu)
        };

        opinionViews = new TextInputEditText[] {
                findViewById(R.id.notePalatulCulturii),
                findViewById(R.id.noteManastireaTreiIerarhi),
                findViewById(R.id.noteCatedralaMitropolitana),
                findViewById(R.id.noteBojdeucaIonCreanga),
                findViewById(R.id.noteParculCopou),
                findViewById(R.id.notePalatulRoznovanu)
        };

        recommendationViews = new TextInputEditText[] {
                findViewById(R.id.recommendationPalatulCulturii),
                findViewById(R.id.recommendationManastireaTreiIerarhi),
                findViewById(R.id.recommendationCatedralaMitropolitana),
                findViewById(R.id.recommendationBojdeucaIonCreanga),
                findViewById(R.id.recommendationParculCopou),
                findViewById(R.id.recommendationPalatulRoznovanu)
        };
    }
