...
public class Lugoj extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "LugojPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Lugoj";
    ...
    private static final String LUGOJ_CITY_ID = "673634";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + LUGOJ_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Lugoj
        loadSavedImages();
        ...
        if (viewCitiesButton != null) {
            ...
            android.util.Log.e("Lugoj", "viewCitiesButton not found in layout");
        }
        ...
        mapButton.setText("Harta Interactivă Lugoj");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Lugoj location
            Uri gmmIntentUri = Uri.parse("geo:45.6909,21.9031?q=Lugoj,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("lugoj_1");
        defaultImages.add("lugoj_podul_de_fier");
        defaultImages.add("lugoj_biserica");
        defaultImages.add("lugoj_primaria");
        defaultImages.add("lugoj_parc");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Internațional de Folclor 'Ana Lugojana' - 15-17 Iulie 2024",
                "Concert Corul 'Ion Vidu' - 22 Iulie 2024",
                "Zilele Lugojului - 5-7 August 2024",
                "Expoziție Traian Vuia - 10-20 August 2024"
        };

        String[] tips = {
                "Vizitați Podul de Fier la apus pentru o priveliște spectaculoasă",
                "Cea mai bună plăcintă bănățeană se găsește la 'Cofetăria Savarina'",
                "O plimbare pe malul râului Timiș dimineața devreme este o experiență de neuitat",
                "Biserica Ortodoxă 'Adormirea Maicii Domnului' este deschisă vizitatorilor zilnic"
        };
        ...
        weatherTitle.setText("Vremea în Lugoj");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Lugoj");
        ...
        photoTitle.setText("Provocare Foto: Capturați Lugoj");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Lugoj și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Lugoj! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Lugoj
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Lugoj are o istorie bogată, fiind un important centru cultural și politic pentru românii din Banat. Orașul este cunoscut ca locul de naștere al lui Traian Vuia, pionier al aviației, și a jucat un rol important în mișcările naționale românești din secolul al XIX-lea.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Lugoj este situat în partea de est a județului Timiș, pe ambele maluri ale râului Timiș. Poziția sa geografică îi conferă un climat temperat-continental moderat, cu influențe mediteraneene.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Podul de Fier, Biserica Ortodoxă 'Adormirea Maicii Domnului', Biserica Romano-Catolică, Casa Memorială Traian Vuia și Turnul Sfântul Nicolae sunt printre principalele atracții turistice din Lugoj.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Lugoj este cunoscut ca un important centru cultural al Banatului, cu o bogată tradiție muzicală și corală. Corul 'Ion Vidu' și Festivalul Internațional de Folclor 'Ana Lugojana' sunt emblematice pentru oraș.",
                false
        );
        ...
        // Add Podul de Fier attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Podul de Fier",
                R.drawable.lugoj, //ic_bridge, // Make sure this resource exists
                "Părerea ta despre Podul de Fier"
        );

        // Add Casa Memorială Traian Vuia attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Casa Memorială Traian Vuia",
                R.drawable.ic_museum, // Make sure this resource exists
                "Părerea ta despre Casa Memorială Traian Vuia"
        );
    }
