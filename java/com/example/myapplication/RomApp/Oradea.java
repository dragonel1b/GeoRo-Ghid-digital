...
public class Oradea extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "OradeaPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Oradea";
    ...
    private static final String ORADEA_CITY_ID = "671768";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + ORADEA_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Oradea
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Oradea");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Oradea location
            Uri gmmIntentUri = Uri.parse("geo:47.0465,21.9189?q=Oradea,Romania");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Oradea");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Oradea");
        ...
        photoTitle.setText("Provocare Foto: Capturați Oradea");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Oradea și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Oradea! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Oradea
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Oradea, un oraș cu o istorie bogată, a fost atestat documentar în anul 1113. De-a lungul timpului, orașul a făcut parte din diverse entități politice: Regatul Ungariei, Imperiul Otoman, Imperiul Habsburgic și, din 1918, România. Arhitectura sa reflectă influențele acestei istorii diverse.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Oradea este situată în vestul României, în județul Bihor, la aproximativ 10 km de granița cu Ungaria. Orașul este străbătut de râul Crișul Repede și se află într-o zonă de câmpie. Clima este temperat-continentală, cu influențe oceanice.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Cetatea Oradea, una dintre cele mai bine conservate fortificații din Europa Centrală, Palatul Vulturul Negru, un splendid edificiu Art Nouveau, și Basilica Romano-Catolică sunt doar câteva dintre atracțiile care fac din Oradea o destinație turistică de top.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Un oraș cu o bogată moștenire multiculturală, Oradea îmbină armonios elementele românești, maghiare și evreiești. Numeroasele clădiri în stil Art Nouveau și Secession formează cel mai mare ansamblu arhitectonic în acest stil din România.",
                false
        );
        ...
        AttractionHelper.addAttraction(
                ...
                R.drawable.piata_unirii, // Make sure this resource exists
                "Părerea ta despre Piața Unirii și Palatul Vulturul Negru"
        );
        ...
        AttractionHelper.addAttraction(
                ...
                container,
                "Complexul Baroc",
                R.drawable.comp_baroc, // Make sure this resource exists
                "Părerea ta despre Complexul Baroc"
        );
    }
    ...
    protected String getCityDescription() {
        return "Oradea, oraș situat în vestul României, este cunoscut pentru arhitectura impresionantă în stil Art Nouveau, apele termale și Cetatea Oradea, o fortificație în formă de stea.";
    }
}
