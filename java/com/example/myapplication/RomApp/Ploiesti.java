...
public class Ploiesti extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "PloiestiPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Ploiesti";
    ...
    private static final String PLOIESTI_CITY_ID = "670609"; // Ploiesti city ID
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + PLOIESTI_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Ploiesti
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Ploiești");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Ploiesti location
            Uri gmmIntentUri = Uri.parse("geo:44.9391,26.0299?q=Ploiesti,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("muntenia_ploiesti_centru");
        defaultImages.add("muntenia_ploiesti_parc");
        defaultImages.add("muntenia_ploiesti_muzeu");
        defaultImages.add("muntenia_ploiesti_catedrala");
        defaultImages.add("muntenia_ploiesti_rafinarie");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Ploiești");
        ...
        // Listă de evenimente
        final String[] events = {
                "Festivalul Castanilor - 15-17 Septembrie 2024",
                "Zilele Orașului Ploiești - 20-22 Mai 2024",
                "Târgul de Toamnă - 10-15 Octombrie 2024",
                "Festivalul de Jazz & Blues - 5-7 August 2024",
                "Expoziția Industriei Petroliere - 1-3 Iunie 2024"
        };
        ...
        showMoreButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Ploiești");
        ...
        // Lista de sfaturi pentru Ploiești
        String[] tips = {
                "Vizitați Muzeul Național al Petrolului pentru a înțelege istoria industriei petroliere din România",
                "Parcul Bucov este perfect pentru o zi de relaxare în natură, cu spații pentru picnic și activități în aer liber",
                "Centrul Vechi oferă numeroase restaurante cu preparate tradiționale prahovene",
                "Nu ratați Ceasul din centrul orașului, simbol al Ploieștiului, realizat în 1936"
        };
        ...
        photoTitle.setText("Provocare Foto: Capturați Ploiești");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Ploiești și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Ploiești! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Ploiești
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Orașul Ploiești, reședință a județului Prahova, are o istorie bogată strâns legată de industria petrolieră a României. Prima atestare documentară datează din 1503, într-un document semnat de Radu cel Mare. Dezvoltarea majoră a orașului a început în secolul al XIX-lea, odată cu exploatarea petrolului din zonă, Ploieștiul devenind primul centru de rafinare a petrolului din lume în 1857. În timpul celui de-al Doilea Război Mondial, orașul a suferit bombardamente masive din cauza importanței sale strategice ca centru petrolier.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Ploieștiul este situat în partea de sud a României, în centrul Câmpiei Române, la aproximativ 60 km nord de București. Cu o suprafață de aproximativ 58 km², orașul se află la o altitudine medie de 150 m deasupra nivelului mării. Clima este temperat-continentală, cu veri calde și ierni relativ reci. Râul Teleajen curge pe la marginea estică a orașului, iar în apropiere se află câmpiile petroliere care au contribuit la dezvoltarea sa economică.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Principalele atracții din Ploiești includ Muzeul Național al Petrolului, unic în Europa prin exponatele sale legate de istoria industriei petroliere, Muzeul Ceasului 'Nicolae Simache' care adăpostește o colecție impresionantă de ceasuri vechi, Muzeul Județean de Istorie și Arheologie Prahova, și Muzeul de Artă. Centrul istoric al orașului, cu Bulevardul Republicii și Palatul Culturii, oferă o arhitectură interesantă din perioada interbelică. În apropierea Ploieștiului se află Parcul Memorial Constantin Stere de la Bucov, un loc popular pentru recreere.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Viața culturală a Ploieștiului este reprezentată prin instituții precum Teatrul 'Toma Caragiu', Filarmonica 'Paul Constantinescu', și Biblioteca Județeană 'Nicolae Iorga'. Orașul găzduiește anual festivaluri și evenimente culturale importante, cum ar fi Festivalul Castanilor, dedicat muzicii folk, Festivalul de Jazz & Blues, și diverse expoziții organizate de muzeele locale. Palatul Culturii, construit între 1920 și 1933, este un important centru cultural care adăpostește mai multe muzee și galerii de artă.",
                false
        );
...
*/
        ...
        // Add Muzeul Petrolului attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Național al Petrolului",
                R.drawable.muzeu_petrol, // Make sure this resource exists
                "Părerea ta despre Muzeul Național al Petrolului"
        );

        // Add Muzeul Ceasului attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Ceasului",
                R.drawable.muzeu_ceas, // Make sure this resource exists
                "Părerea ta despre Muzeul Ceasului"
        );
    }
