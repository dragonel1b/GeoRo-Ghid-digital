...
public class Sighetu extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "SighetuPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Sighetu";
    ...
    private static final String SIGHETU_CITY_ID = "667268";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + SIGHETU_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Sighetu
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Sighetu Marmației");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Sighetu location
            Uri gmmIntentUri = Uri.parse("geo:47.9275,23.8902?q=Sighetu+Marmatiei,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("maramures_sighetu_1");
        defaultImages.add("maramures_sighetu_memorial");
        defaultImages.add("maramures_sighetu_centru");
        defaultImages.add("maramures_sighetu_muzeu");
        defaultImages.add("maramures_sighetu_traditional");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Sighetu Marmației");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Sighetu Marmației");
        ...
        photoTitle.setText("Provocare Foto: Capturați Sighetu Marmației");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Sighetu Marmației și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Sighetu Marmației! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Sighetu
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Sighetu Marmației, cunoscut și ca Sighet, este un important centru cultural și istoric din nordul României, în Maramureș. Orașul are o istorie bogată, fiind atestat documentar în secolul al XIV-lea și dezvoltându-se ca un important centru comercial și administrativ al regiunii.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situat în nordul României, în județul Maramureș, orașul este străbătut de râul Mureș și se află la poalele estice ale Câmpiei Panonice. Poziția sa geografică l-a transformat într-un important nod de transport și comunicații, fiind o poartă de intrare în România dinspre Europa Centrală.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Cetatea Sighetului, o impresionantă fortăreață în stil Vauban, Palatul Cultural, un edificiu în stil eclectic, și Palatul Administrativ sunt doar câteva dintre monumentele remarcabile ale orașului. Malurile râului Mureș oferă spații verzi relaxante pentru locuitori și turiști.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Sighetu Marmației este un important centru cultural, cu o bogată activitate teatrală, muzicală și artistică. Teatrul Clasic Ioan Slavici, Filarmonica de Stat și numeroasele galerii de artă contribuie la viața culturală diversificată a orașului.",
                false
        );
...
*/
        ...
        // Add Casino attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Cuiul în care se agață harta",
                R.drawable.cui, // Make sure this resource exists
                "Părerea ta despre Cuiul în care se agață harta"
        );

        // Add Genoese Lighthouse attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Satului Maramureșean",
                R.drawable.muzeu_sat_mar, // Make sure this resource exists
                "Părerea ta despre Muzeul Satului Maramureșean"
        );
    }

    @Override
    protected String getCityName() {
        return "Sighetu Marmației";
    }
    ...
    protected String getCityDescription() {
        return "Sighetu Marmației este un oraș încărcat de istorie și cultură, cunoscut pentru Memorialul Victimelor Comunismului, Casa Memorială Elie Wiesel și numeroasele sale muzee care păstrează tradițiile maramureșene.";
    }
}
