...
public class Slatina extends AppCompatActivity {
    ...
    private String[] locationKeys = {
            "parcul_tineretului",
            "muzeul_judetean_olt",
            "biserica_sf_gheorghe",
            "centrul_vechi",
            "lacul_brates",
            "palatul_administrativ"
    };

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_slatina);

        sharedPreferences = getSharedPreferences("SlatinaData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        imageViews = new ImageView[] {
                ...
                findViewById(R.id.imageCentru),
                findViewById(R.id.imageLac),
        ...
        checkViews = new ImageView[] {
                ...
                findViewById(R.id.checkCentru),
                findViewById(R.id.checkLac),
        ...
        opinionViews = new TextInputEditText[] {
                ...
                findViewById(R.id.noteCentru),
                findViewById(R.id.noteLac),
        ...
        recommendationViews = new TextInputEditText[] {
                ...
                findViewById(R.id.recommendationCentru),
                findViewById(R.id.recommendationLac),
