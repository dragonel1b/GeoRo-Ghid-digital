...
public class Soroca extends AppCompatActivity {
    ...
    private String[] locationKeys = {
            ...
            "complexul_memorial",
            "biserica_sf_dumitru",
            "monumentul_lumanarea_recunostintei",
            "dealul_romilor"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soroca); // Make sure to create this layout file

        sharedPreferences = getSharedPreferences("SorocaData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        cardViews = new ConstraintLayout[] {
                findViewById(R.id.cardCetateaSoroca),
                findViewById(R.id.cardMuzeulEtnografic),
                findViewById(R.id.cardComplexulMemorial),
                findViewById(R.id.cardBisericaSfDumitru),
                findViewById(R.id.cardMonumentulLumanareaRecunostintei),
                findViewById(R.id.cardDealulRomilor)
        };

        imageViews = new ImageView[] {
                findViewById(R.id.imageCetateaSoroca),
                findViewById(R.id.imageMuzeulEtnografic),
                findViewById(R.id.imageComplexulMemorial),
                findViewById(R.id.imageBisericaSfDumitru),
                findViewById(R.id.imageMonumentulLumanareaRecunostintei),
                findViewById(R.id.imageDealulRomilor)
        };

        checkViews = new ImageView[] {
                findViewById(R.id.checkCetateaSoroca),
                findViewById(R.id.checkMuzeulEtnografic),
                findViewById(R.id.checkComplexulMemorial),
                findViewById(R.id.checkBisericaSfDumitru),
                findViewById(R.id.checkMonumentulLumanareaRecunostintei),
                findViewById(R.id.checkDealulRomilor)
        };

        opinionViews = new TextInputEditText[] {
                findViewById(R.id.noteCetateaSoroca),
                findViewById(R.id.noteMuzeulEtnografic),
                findViewById(R.id.noteComplexulMemorial),
                findViewById(R.id.noteBisericaSfDumitru),
                findViewById(R.id.noteMonumentulLumanareaRecunostintei),
                findViewById(R.id.noteDealulRomilor)
        };

        recommendationViews = new TextInputEditText[] {
                findViewById(R.id.recommendationCetateaSoroca),
                findViewById(R.id.recommendationMuzeulEtnografic),
                findViewById(R.id.recommendationComplexulMemorial),
                findViewById(R.id.recommendationBisericaSfDumitru),
                findViewById(R.id.recommendationMonumentulLumanareaRecunostintei),
                findViewById(R.id.recommendationDealulRomilor)
        };
    }
