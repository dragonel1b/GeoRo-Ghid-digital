...
public class TarguJiu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_targujiu);

        sharedPreferences = getSharedPreferences("TarguJiuData", MODE_PRIVATE);
