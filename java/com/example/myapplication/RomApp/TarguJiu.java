...
public class TarguJiu extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "TarguJiuPrefs";
    private static final String USER_IMAGES_KEY = "userImages_TarguJiu";
    ...
    private static final String TARGU_JIU_CITY_ID = "665087";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + TARGU_JIU_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Târgu Jiu
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Târgu Jiu");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Târgu Jiu location
            Uri gmmIntentUri = Uri.parse("geo:45.0428,23.2712?q=Targu+Jiu,Romania");
        ...
        // Adăugăm și butonul pentru harta regiunii Oltenia
        Button olteniaMapButton = new Button(this);
        olteniaMapButton.setText("Harta Regiunii Oltenia");
        olteniaMapButton.setBackgroundColor(Color.parseColor("#FF5722"));
        olteniaMapButton.setTextColor(Color.WHITE);
        olteniaMapButton.setPadding(32, 16, 32, 16);
        
        LinearLayout.LayoutParams olteniaParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.WRAP_CONTENT);
        olteniaParams.setMargins(0, 8, 0, 16);
        olteniaMapButton.setLayoutParams(olteniaParams);
        
        olteniaMapButton.setOnClickListener(v -> {
            // Open Google Maps with Oltenia region
            Uri gmmIntentUri = Uri.parse("geo:44.3141,23.8177?q=Oltenia,Romania&z=8");
            Intent mapIntent = new Intent(Intent.ACTION_VIEW, gmmIntentUri);
            mapIntent.setPackage("com.google.android.apps.maps");
            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                startActivity(mapIntent);
        ...
        if (tabLayout != null) {
            ...
            if (parent != null) {
                ...
                parent.addView(olteniaMapButton);
    }
        }
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("oltenia_targujiu_1");
        defaultImages.add("oltenia_targujiu_coloana");
        defaultImages.add("oltenia_targujiu_poarta");
        defaultImages.add("oltenia_targujiu_masa");
        defaultImages.add("oltenia_targujiu_parc");
    ...
    private void setupSpecialFeatures() {
        ...
        String[] events = {
                "Festivalul Internațional Brâncuși - 19-23 Februarie 2024",
                "Ziua Municipiului Târgu Jiu - 21-23 Mai 2024",
                "Festivalul Național de Folk și Baladă - 15-17 Iulie 2024",
                "Festivalul Castanilor - 1-5 Octombrie 2024"
        };

        String[] tips = {
                "Ansamblul Monumental Brâncuși se vizitează cel mai bine dimineața devreme sau seara târziu pentru fotografii ideale",
                "Cafeaua la Coloana Infinitului se savurează la cafeneaua din apropiere",
                "Piața centrală oferă produse locale autentice în fiecare zi de sâmbătă",
                "Muzeul Județean Gorj este gratuit în ultima vineri din lună"
        };
        ...
        weatherTitle.setText("Vremea în Târgu Jiu");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Târgu Jiu");
        ...
        photoTitle.setText("Provocare Foto: Descoperă Târgu Jiu");
        ...
        photoDesc.setText("Imortalizează cele mai frumoase locuri din Târgu Jiu și adaugă-le în colecția ta personală!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Târgu Jiu! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Târgu Jiu
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Târgu Jiu, reședință de județ în Gorj, a fost atestat documentar prima dată în 1406. Numele vine de la \"târgul\" care se organiza pe malurile Jiului. Orașul a dobândit o importanță culturală specială datorită lui Constantin Brâncuși, care a realizat aici celebrul ansamblu sculptural monumental.",
                true
        );
        ...
        addSection(
                ...
                "Ansamblul sculptural realizat de Constantin Brâncuși la Târgu Jiu reprezintă una dintre cele mai importante opere de artă modernă din lume. Finalizat în 1938, ansamblul este compus din trei componente principale: Coloana Infinitului (simbolizând sacrificiul fără sfârșit), Poarta Sărutului (simbolizând trecerea spre o altă viață) și Masa Tăcerii (simbolizând liniștea dinaintea luptei).",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Târgu Jiu este un important centru cultural, cu instituții precum Teatrul Dramatic \"Elvira Godeanu\", Muzeul Județean \"Alexandru Ștefulescu\" și Casa Memorială Ecaterina Teodoroiu. Festivalul Internațional Brâncuși și Festivalul Național de Folk și Baladă sunt evenimente culturale de referință.",
                false
        );
        ...
        // Add Coloana Infinitului attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Coloana Infinitului",
                R.drawable.coloana, // Utilizăm ic_museum temporar
                "Părerea ta despre Coloana Infinitului"
        );

        // Add Poarta Sărutului attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Poarta Sărutului",
                R.drawable.poarta_sarutului, // Utilizăm ic_museum temporar
                "Părerea ta despre Poarta Sărutului"
        );

        // Add Masa Tăcerii attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Masa Tăcerii",
                R.drawable.masa_tacerii, // Utilizăm ic_museum temporar
                "Părerea ta despre Masa Tăcerii"
        );

        // Add Muzeul Județean Gorj attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Muzeul Județean Gorj",
                R.drawable.muzeu_jud_gorj,
                "Părerea ta despre Muzeul Județean"
        );

        // Add Casa Memorială Ecaterina Teodoroiu attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Casa Memorială Ecaterina Teodoroiu",
                R.drawable.casa_memoriala, // Utilizăm ic_beach temporar
                "Părerea ta despre Casa Memorială"
        );
    }
