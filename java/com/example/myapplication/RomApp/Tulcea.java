...
public class Tulcea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tulcea);

        sharedPreferences = getSharedPreferences("TulceaData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        cardViews = new ConstraintLayout[] {
                findViewById(R.id.cardDeltaDunarii),
                findViewById(R.id.cardMuzeulDelta),
                findViewById(R.id.cardCimitirulEroilor),
                findViewById(R.id.cardBisericaSfNicolae)
        };

        imageViews = new ImageView[] {
                findViewById(R.id.imageDeltaDunarii),
                findViewById(R.id.imageMuzeulDelta),
                findViewById(R.id.imageCimitirulEroilor),
                findViewById(R.id.imageBisericaSfNicolae)
        };

        checkViews = new ImageView[] {
                findViewById(R.id.checkDeltaDunarii),
                findViewById(R.id.checkMuzeulDelta),
                findViewById(R.id.checkCimitirulEroilor),
                findViewById(R.id.checkBisericaSfNicolae)
        };

        opinionViews = new TextInputEditText[] {
                findViewById(R.id.noteDeltaDunarii),
                findViewById(R.id.noteMuzeulDelta),
                findViewById(R.id.noteCimitirulEroilor),
                findViewById(R.id.noteBisericaSfNicolae)
        };

        recommendationViews = new TextInputEditText[] {
                findViewById(R.id.recommendationDeltaDunarii),
                findViewById(R.id.recommendationMuzeulDelta),
                findViewById(R.id.recommendationCimitirulEroilor),
