...
public class Valcea extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valcea);

        sharedPreferences = getSharedPreferences("ValceaData", MODE_PRIVATE);
    ...
    private void initializeViews() {
        cardViews = new ConstraintLayout[] {
                findViewById(R.id.cardCozia),
                findViewById(R.id.cardCalimanesti),
                findViewById(R.id.cardHurezi),
                findViewById(R.id.cardHorezu)
        };

        imageViews = new ImageView[] {
                findViewById(R.id.imageCozia),
                findViewById(R.id.imageCalimanesti),
                findViewById(R.id.imageHurezi),
                findViewById(R.id.imageHorezu)
        };

        checkViews = new ImageView[] {
                findViewById(R.id.checkCozia),
                findViewById(R.id.checkCalimanesti),
                findViewById(R.id.checkHurezi),
                findViewById(R.id.checkHorezu)
        };

        opinionViews = new TextInputEditText[] {
                findViewById(R.id.noteCozia),
                findViewById(R.id.noteCalimanesti),
                findViewById(R.id.noteHurezi),
                findViewById(R.id.noteHorezu)
        };

        recommendationViews = new TextInputEditText[] {
                findViewById(R.id.recommendationCozia),
                findViewById(R.id.recommendationCalimanesti),
                findViewById(R.id.recommendationHurezi),
                findViewById(R.id.recommendationHorezu)
        };
    }
