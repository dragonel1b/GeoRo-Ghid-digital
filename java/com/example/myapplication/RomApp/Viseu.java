...
public class Viseu extends EnhancedCityActivity {
    private static final int PICK_IMAGE_REQUEST = 1;
    private static final String PREFS_NAME = "ViseuPrefs";
    private static final String USER_IMAGES_KEY = "userImages_Viseu";
    ...
    private static final String VISEU_CITY_ID = "662459";
    private static final String WEATHER_API_URL = "https://api.openweathermap.org/data/2.5/weather?id=" + VISEU_CITY_ID + "&appid=" + WEATHER_API_KEY + "&units=metric&lang=ro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Încărcăm doar imaginile salvate pentru Viseu
        loadSavedImages();
        ...
        mapButton.setText("Harta Interactivă Vișeu de Sus");
        ...
        mapButton.setOnClickListener(v -> {
            // Open Google Maps with Viseu location
            Uri gmmIntentUri = Uri.parse("geo:47.7114,24.4418?q=Viseu+de+Sus,Romania");
    ...
    private void setupImageCarouselWithoutUserImages() {
        ...
        defaultImages.add("maramures_viseu_1");
        defaultImages.add("maramures_viseu_mocanita");
        defaultImages.add("maramures_viseu_centru");
        defaultImages.add("maramures_viseu_biserica");
        defaultImages.add("maramures_viseu_traditional");
    ...
    private void setupSpecialFeatures() {
        ...
        weatherTitle.setText("Vremea în Vișeu de Sus");
        ...
        eventsButton.setOnClickListener(v -> {
            ...
            builder.setTitle("Evenimente în Vișeu de Sus");
        ...
        photoTitle.setText("Provocare Foto: Capturați Vișeu de Sus");
        ...
        photoDesc.setText("Capturați cele mai frumoase locuri din Vișeu de Sus și împărtășiți-le cu noi!");
    ...
    private void addWelcomeBackMessage() {
        ...
        welcomeText.setText("Bine ai revenit în Vișeu de Sus! Aceasta este vizita ta #" + visitCount);
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null) {
            ...
            if (selectedImageUri != null) {
                try {
                    ...
                    // Verificăm dacă avem deja 5 imagini pentru Viseu
    ...
    protected void initializeSpecificContent() {
        ...
        addSection(
                ...
                "Istorie și Tradiție",
                "Vișeu de Sus este un oraș din județul Maramureș, cunoscut în special pentru Mocănița - calea ferată forestieră cu locomotive cu abur, una dintre ultimele de acest fel din Europa care încă funcționează. Localitatea are o bogată tradiție în exploatarea și prelucrarea lemnului, fiind situată într-o zonă cu păduri bogate.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Geografie",
                "Situat în nordul României, în Maramureș, orașul Vișeu de Sus este traversat de râul Vișeu, într-o zonă bogată în păduri de conifere, cu un peisaj montan spectaculos. Înconjurat de munții Maramureșului, orașul se bucură de un cadru natural deosebit, propice pentru activități în aer liber și turism montan.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Atracții Turistice",
                "Mocănița - trenul cu abur pe Valea Vaserului este principala atracție turistică a orașului. Alte puncte de interes includ Muzeul de Artă și Etnografie, bisericile vechi din lemn din zonă, și traseele montane din împrejurimi care oferă panorame spectaculoase asupra munților Maramureșului.",
                true
        );
        ...
        addSection(
                findViewById(R.id.cityContentContainer),
                "Cultură",
                "Vișeu de Sus păstrează cu mândrie tradițiile și obiceiurile maramureșene, cu o comunitate activă de meșteșugari în prelucrarea lemnului. Festivalurile locale și evenimentele culturale care au loc periodic, precum și Muzeul de Artă și Etnografie, contribuie la menținerea identității culturale a zonei.",
                false
        );
...
*/
        ...
        // Add Mocanita attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Mocănița",
                R.drawable.mocanita, // Make sure this resource exists
                "Părerea ta despre Mocăniță"
        );

        // Add Mountain Trails attraction
        AttractionHelper.addAttraction(
                this,
                container,
                "Trasee Montane",
                R.drawable.trasee_montane, // Make sure this resource exists
                "Părerea ta despre traseele montane"
        );
    }
    ...
    protected String getCityDescription() {
        return "Vișeu de Sus, cunoscută pentru Mocănița - trenul forestier cu abur, este un oraș pitoresc din Maramureș, înconjurat de munți și păduri, păstrând tradițiile locale și meșteșugurile vechi.";
    }
}
